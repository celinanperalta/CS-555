...
MSG_US35 = "Anomaly US35: {0} was just born in the past 30 days. They were born on {1}"
MSG_US36 = "Anomaly US36: {0} passed away in the past 30 days. They passed away on {1}"
